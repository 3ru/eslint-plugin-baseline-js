...
const descriptors: ReadonlyArray<Descriptor> = [
  ...
  {
    "featureId": "secure-payment-confirmation",
    "kind": "callStatic",
    "base": "PaymentRequest",
    "prop": "securePaymentConfirmationAvailability"
  },
  {
    "featureId": "select",
    "kind": "instanceMember",
