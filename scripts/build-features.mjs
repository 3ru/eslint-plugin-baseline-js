...
const rootBaselineDir = resolve(__dirname, "..", "src", "baseline");
...
// Also write legacy aggregator for mapping/check scripts: src/baseline/features.ts
const legacyHeader = `/**\n * @fileoverview AUTOGENERATED — Aggregated JavaScript language features from web-features.\n * THIS FILE IS AUTOGENERATED. DO NOT MODIFY DIRECTLY.\n */`;
const legacyTs = `${legacyHeader}\n\nexport default ${JSON.stringify(out, null, 2)} as const;\n`;
const legacyPath = resolve(rootBaselineDir, "features.ts");
writeFileSync(legacyPath, legacyTs, "utf-8");

console.log(`Wrote ${Object.keys(out).length} JS language features to ${outTs} and ${legacyPath}`);
